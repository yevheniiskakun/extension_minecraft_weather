...
quote_list = ["Everything is hard before it is easy.", "The past is behind, learn from it. The future is ahead, prepare for it. The present is here, live it.", "If you cannot find peace within yourself, you will never find it anywhere else.", "Count your age by friends, not years. Count your life by smiles, not tears.", "Knowing yourself is the beginning of all wisdom.", "Your focus determines your reality.", "The ability to speak does not make you intelligent.", "Do or do not. There is no try.", "The Force will be with you always.", "Your eyes can deceive you; don't trust them.", "Knowledge is knowing what to say. Wisdom is knowing when to say it.", "What you spend years building may be destroyed overnight. Build anyway", "This isn't about the past! It's about the future!", "If at first you don't succeed... succeed later than originally planned.", "Never dig straight down", "Keep calm and play Minecraft", "With great power comes great responsibility", "12345 is a bad password!", "Awesome game design right there!", "Don't look directly at the bugs!", "Lennart lennart = new Lennart();", "Made in Sweden!", "Stay home and play video games!", "Who lives in a pineapple under the sea?", "Be brave like Ukraine", "We live every day we only die once", "Veni, Vidi, Vici!", "The purpose of our lives is to be happy", "My mama always said, life is like a box of chocolates. You never know what you are gonna get", "There are no mistakes, only opportunities", "I would wish you good luck, but luck won't carry you through the Nether.", "Education is the movement from darkness to light.", "Science is organized knowledge. Wisdom is organized life."];
